...
import ${groupId}.test.utils.UnitTestHelper;
...
public class BasicAsaParserTest {
    ...
    public void testCISCOFW106023() {
        String rawMessage = "<164>Aug 05 2016 01:01:34: %ASA-4-106023: Deny tcp src Inside:10.30.9.121/54580 dst Outside:192.168.135.51/42028 by access-group ${symbol_escape}"Inside_access_in${symbol_escape}" [0x962df600, 0x0]";
    ...
    public void testInvalidIpAddr() {
        String rawMessage = "<164>Aug 05 2016 01:01:34: %ASA-4-106023: Deny tcp src Inside:10.30.9.121/54580 dst Outside:192.168.256.51/42028 by access-group ${symbol_escape}"Inside_access_in${symbol_escape}" [0x962df600, 0x0]";
        JSONObject asaJson = asaParser.parse(rawMessage.getBytes()).get(0);
        assertEquals(asaJson.get("original_string"), rawMessage);
        assertTrue((long) asaJson.get("timestamp") == 1470358894000L);
