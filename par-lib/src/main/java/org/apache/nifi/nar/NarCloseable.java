...
public class NarCloseable implements Closeable {
    ...
    public static NarCloseable withNarLoader() throws NotInitializedException{
     ...
     */
    public static NarCloseable withComponentNarLoader(final Class componentClass, final String componentIdentifier) throws NotInitializedException{
        final ClassLoader current = Thread.currentThread().getContextClassLoader();
