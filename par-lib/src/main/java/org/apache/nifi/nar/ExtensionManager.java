...
public class ExtensionManager {
     ...
     */
    public static ClassLoader getClassLoader(final String classType)  throws NotInitializedException {
        checkInitialized();
     ...
     */
    public static ClassLoader getClassLoader(final String classType, final String instanceIdentifier) throws NotInitializedException  {
        checkInitialized();
     ...
     */
    public static boolean requiresInstanceClassLoading(final String classType)  throws NotInitializedException {
        checkInitialized();
        return requiresInstanceClassLoading.contains(classType);
    }

    public static Set<Class> getExtensions(final Class<?> definition)  throws NotInitializedException {
        checkInitialized();
