...
#extensions
Source9:        metron-parser-asa-assembly-%{full_version}-archive.tar.gz
Source10:       metron-parser-bro-assembly-%{full_version}-archive.tar.gz
Source11:       metron-parser-cef-assembly-%{full_version}-archive.tar.gz
Source12:       metron-parser-fireeye-assembly-%{full_version}-archive.tar.gz
Source13:       metron-parser-ise-assembly-%{full_version}-archive.tar.gz
Source14:       metron-parser-lancope-assembly-%{full_version}-archive.tar.gz
Source15:       metron-parser-logstash-assembly-%{full_version}-archive.tar.gz
Source16:       metron-parser-paloalto-assembly-%{full_version}-archive.tar.gz
Source17:       metron-parser-snort-assembly-%{full_version}-archive.tar.gz
Source18:       metron-parser-sourcefire-assembly-%{full_version}-archive.tar.gz
Source19:       metron-parser-squid-assembly-%{full_version}-archive.tar.gz
Source20:       metron-parser-websphere-assembly-%{full_version}-archive.tar.gz
Source21:       metron-parser-yaf-assembly-%{full_version}-archive.tar.gz
...
tar -xzf %{SOURCE9} -C %{buildroot}%{metron_extensions_etc_parsers}/asa
tar -xzf %{SOURCE10} -C %{buildroot}%{metron_extensions_etc_parsers}/bro
tar -xzf %{SOURCE11} -C %{buildroot}%{metron_extensions_etc_parsers}/cef
tar -xzf %{SOURCE12} -C %{buildroot}%{metron_extensions_etc_parsers}/fireeye
tar -xzf %{SOURCE13} -C %{buildroot}%{metron_extensions_etc_parsers}/ise
tar -xzf %{SOURCE14} -C %{buildroot}%{metron_extensions_etc_parsers}/lancope
tar -xzf %{SOURCE15} -C %{buildroot}%{metron_extensions_etc_parsers}/logstash
tar -xzf %{SOURCE16} -C %{buildroot}%{metron_extensions_etc_parsers}/paloalto
tar -xzf %{SOURCE17} -C %{buildroot}%{metron_extensions_etc_parsers}/snort
tar -xzf %{SOURCE18} -C %{buildroot}%{metron_extensions_etc_parsers}/sourcefire
tar -xzf %{SOURCE19} -C %{buildroot}%{metron_extensions_etc_parsers}/squid
tar -xzf %{SOURCE20} -C %{buildroot}%{metron_extensions_etc_parsers}/websphere
tar -xzf %{SOURCE21} -C %{buildroot}%{metron_extensions_etc_parsers}/yaf
