...
hdfs_metron_apps_extensions = format(format(config['configurations']['metron-env']['metron_apps_extensions_hdfs_dir']))
...
hdfs_metron_apps_extensions_alt = format(format(config['configurations']['metron-env']['metron_apps_extensions_alt_hdfs_dir']))
