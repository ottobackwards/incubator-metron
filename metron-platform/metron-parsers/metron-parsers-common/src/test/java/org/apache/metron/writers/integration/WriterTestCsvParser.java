...
public class WriterTestCsvParser extends BasicParser{
  protected static final Logger LOG = LoggerFactory.getLogger(WriterTestCsvParser.class);
  ...
  public void configure(Map<String, Object> config) {
    ...
    Object tsFormatObj = config.get(TIMESTAMP_FORMAT_CONF);
    if(tsFormatObj != null) {
